...
export type IncrementTrackViewsResponseResolvers<ContextType = TrackContext, ParentType extends ResolversParentTypes['IncrementTrackViewsResponse'] = ResolversParentTypes['IncrementTrackViewsResponse']> = {
...
export type MutationResolvers<ContextType = TrackContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
