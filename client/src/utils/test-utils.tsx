...
export const renderWithRouterGenerator =
  (renderer: typeof renderApollo) =>
  (node: React.ReactElement, options?: RenderApolloOptions) => {
    return renderer(<BrowserRouter>{node}</BrowserRouter>, options);
  };

export const renderWithRouter = renderWithRouterGenerator(
  render as unknown as typeof renderApollo,
);
